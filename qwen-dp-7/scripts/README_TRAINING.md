...
```bash
python qwen-dp-7/scripts/train_stage1.py
```
...
Final System-2 bundle: `outputs_qwen7/stage2/final/system2_aux.pt`
...
Final policy checkpoint: `outputs_qwen7/stage3/final/policy/`

Final System-2 bundle: `outputs_qwen7/stage3/final/system2/system2_aux.pt`

```bash
python qwen-dp-7/scripts/train_stage3.py
```
...
python qwen-dp-7/scripts/train_stage3.py \
  ...
  --stage2-checkpoint outputs_qwen7/stage2/final
```
